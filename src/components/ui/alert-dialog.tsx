...
// ✅ FIXED OVERLAY
// Removed `pointer-events-none` that made buttons unclickable
// Also ensured proper z-index and animation behavior
...
// ✅ Made z-index higher for content (so it sits above the overlay)
